...
const addDepartment = () => {
  inquirer
    ...
    .then((answer) => {
      ...
      connection.query(newDepartment, answer.addDepartment, function (
        err,
        results
      ) {
        if (err) throw err;
        init();
        console.log(
          `Department added successfully: ${answer.addDepartment.toUpperCase()}`
        );
      });
    });
};
            ...
            connection.query(roleIdQuery, params1, (err, res) => {
              ...
              if (manager === "none") {
                ...
                connection.query(newEmployee, params4, function (err, res) {
                  ...
                  init();
                  console.log(
                    `Employee added successfully: ${firstName} ${lastName} !`
                  );
                });
              } else {
